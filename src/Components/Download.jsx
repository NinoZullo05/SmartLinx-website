...
/**
 * Download component for the website.
 * Displays an image and a description with a download button.
 * Uses ParallaxTilt for a 3D effect on the image.
 * 
      ...
      <div className="w-auto mx-auto text-center flex flex-col md:flex-row mt-20">
        <div className="md:w-1/2 md:pr-4 md:pl-8 ml-3 mr-3 flex justify-center items-center">
          <div>
            ...
            <p className="text-lg mb-5 text-text_light dark:text-text_dark">
